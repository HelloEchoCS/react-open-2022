...
const AnecdoteList = ({ anecdotes }) => (
  <div>
    <h2>Anecdotes</h2>
    <ul>
      {anecdotes.map(anecdote => <li key={anecdote.id} ><AnecdoteLink anecdote={anecdote} /></li>)}
    </ul>
  </div>
)
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input name='content' reset='true' {...content.attributes} />
        </div>
        <div>
          author
          <input name='author' reset='true' {...author.attributes} />
        </div>
        <div>
          url for more info
          <input name='info' reset='true' {...info.attributes} />
        </div>
